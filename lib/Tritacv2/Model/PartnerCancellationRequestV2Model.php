 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class PartnerCancellationRequestV2Model implements ArrayAccess
{
    /**
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['cancellation_request'] === null) {
            $invalid_properties[] = "'cancellation_request' can't be null";
        }
     ...
     * @param \Swagger\Client\Model\CancellationRequestV2Model $cancellation_request
     * @return $this
     */
