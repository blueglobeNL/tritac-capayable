...
class Tritac_CapayableApiClient_Models_CreditCheckRequest extends Tritac_CapayableApiClient_Models_BaseModel
{
    ...
    protected $isInThreeInstallments;
    ...
    public function __construct()
    {
        ...
        $this->isFinal      = false;
        $this->claimAmount  = 0;
        $this->isInThreeInstallments = false;
    }
    ...
    function getIsInThreeInstallments() { return $this->isInThreeInstallments; }
    function setIsInThreeInstallments($isInThreeInstallments) {

        if(!is_bool($isInThreeInstallments)) {
            throw new Exception('Is In Three Installments must be a boolean');
        }

        $this->isInThreeInstallments = $isInThreeInstallments;
    }
}