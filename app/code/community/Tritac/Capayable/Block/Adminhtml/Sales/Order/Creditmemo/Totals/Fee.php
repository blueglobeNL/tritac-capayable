<?php
class Tritac_Capayable_Block_Adminhtml_Sales_Order_Creditmemo_Totals_Fee extends Mage_Core_Block_Template
{

    public function initTotals()
    {
        $parent = $this->getParentBlock();
        if($parent->getSource()->getCapayableFee()){
    ...
    public function getValue(){
        return (float) Mage::app()->getStore()->roundPrice($this->getParentBlock()->getSource()->getOrder()->getCapayableFee());
        //return $this->getParentBlock()->getSource()->getOrder()->getBaseCapayableFeeInvoiced();
    }

    public function getBaseValue(){
        return (float) Mage::app()->getStore()->roundPrice($this->getParentBlock()->getSource()->getOrder()->getBaseCapayableFeeInvoiced());
    }

    public function getBaseValueIncTax($format=FALSE){
        $value = $this->getParentBlock()->getSource()->getOrder()->getBaseCapayableFeeInvoiced() + $this->getParentBlock()->getSource()->getOrder()->getBaseCapayableFeeTaxAmountInvoiced();
        if($format){
